...
log_file   = "mein_elba_requests_full.log"  # The input log file name

log_structured_file = output_dir + log_file + "_structured.csv"
log_templates_file = output_dir + log_file + "_templates.csv"
log_sequence_file = output_dir + "http_sequence.csv"
...
def mapping():
    ...
    print(log_temp_dict)
    with open (output_dir + "http_log_templates.json", "w") as f:
...
def http_sampling(log_file, window='session'):
    ...
    with open(output_dir + "http_log_templates.json", "r") as f:
